...
#-----------------------------------------------------------------
echo do_exit __set_current_blocked ttwu_do_wakeup > /sys/kernel/debug/tracing/set_ftrace_filter
echo sys_pause dequeue_signal signal_setup_done sys_sigreturn >> /sys/kernel/debug/tracing/set_ftrace_filter
echo isig >> /sys/kernel/debug/tracing/set_ftrace_filter
sleep 1
